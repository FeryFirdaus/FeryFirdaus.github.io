...
const luarboxexp3 = document.querySelector('.luar-box-exp3');
const boxexp3 = function (entries) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
...
const exp3 = new IntersectionObserver(boxexp3);
exp3.observe(luarboxexp3);
